...
const Socials = ({ justify_center }) => {
    return (
        <div className={`flex ${justify_center ? 'justify-center' : 'justify-start'} items-center gap-4 bg-white p-3 rounded-2xl mt-5`}>
            <SocialButton href="https://github.com/arthurazevedods" bgColor="bg-black" borderColor="border-black" hoverFill="group-hover:fill-[#171543]">
            ...
            <SocialButton href="https://www.linkedin.com/in/arthur-silva-b84064135/" bgColor="bg-blue-400" borderColor="border-blue-400" hoverFill="group-hover:fill-[#171543]">
                <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <SocialButton href="https://x.com/arthurazevds" bgColor="bg-blue-500" borderColor="border-blue-500" hoverFill="group-hover:fill-[#1DA1F2]">
                <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path className="group-hover:fill-[#1DA1F2] fill-white duration-300" d="M22.46 6c-.77.35-1.6.58-2.47.69.89-.53 1.57-1.36 1.88-2.36-.83.49-1.75.85-2.72 1.05-.78-.83-1.88-1.35-3.1-1.35-2.34 0-4.23 1.9-4.23 4.23 0 .33.04.66.11.97-3.52-.18-6.64-1.86-8.73-4.42-.36.63-.57 1.37-.57 2.16 0 1.49.76 2.8 1.91 3.57-.71-.02-1.38-.22-1.96-.55v.06c0 2.08 1.48 3.81 3.44 4.21-.36.1-.75.15-1.15.15-.28 0-.55-.03-.81-.08.55 1.73 2.15 2.99 4.05 3.03-1.48 1.16-3.34 1.85-5.36 1.85-.35 0-.7-.02-1.05-.06 1.91 1.23 4.18 1.95 6.61 1.95 7.94 0 12.28-6.58 12.28-12.28 0-.19 0-.37-.01-.56.84-.61 1.57-1.37 2.15-2.24z" />
                </svg>
            </SocialButton>
        </div>
    );
...
Socials.propTypes = {
    justify_center: PropTypes.bool.isRequired,
};