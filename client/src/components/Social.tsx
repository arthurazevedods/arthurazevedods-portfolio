          ...
          */}
          ...
          <div className="relative">
            ...
            >
              <div
                style={{ clipPath: "url(#squircleClip)" }}
                className="w-14 h-14 bg-gradient-to-br from-[#44475a] to-[#282a36] rounded-xl flex items-center justify-center shadow-lg border border-[#bd93f9]/50 cursor-pointer transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-2 hover:shadow-2xl"
              >
                <FaMedium className="h-8 w-8 text-[#f8f8f8]"/>
